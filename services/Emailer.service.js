...
// Updated sendListingRequestResponse function
async function sendListingRequestResponse(email, callback, subject, htmlBody) {
    const transporter = nodemailer.createTransport({
      host: "smtp-relay.brevo.com",
      port: 587,
      secure: false, // use TLS
      auth: {
        user: "7f58a8001@smtp-brevo.com", // Your Brevo login
        pass: "ZAQY1cpPzmsTx75V", // Your Brevo password
      },
    });
  
    const mailOptions = {
      from: "rentconnect.service@gmail.com", // Replace with your verified sender email
  ...
  // Updated sendProfileRequestResponse function
  async function sendProfileRequestResponse(email, subject, htmlBody, callback) {
    const transporter = nodemailer.createTransport({
        host: "smtp-relay.brevo.com",
        port: 587,
        secure: false, // use TLS
